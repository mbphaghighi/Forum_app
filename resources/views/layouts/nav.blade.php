            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="{{route('threads')}}?unanswered=1">Unanswered Thread</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @foreach(App\Models\Channel::all() as $channel)
                            <a class="dropdown-item" href="{{route('threads')}}/{{ $channel->slug }}">{{ $channel->name }}</a>
                        @endforeach
                    </div>
                </li>
            </ul>
                ...
                @else
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a href="{{ route('profile', auth()->user()) }}" class="dropdown-item">My Activities</a>
